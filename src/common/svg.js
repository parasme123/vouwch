...
export const phoneIcon = (width, height, color) => {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 21.261 21.298">
            <Path id="phone-icon" d="M13.976,4.668A4.585,4.585,0,0,1,17.6,8.29M13.976,1a8.253,8.253,0,0,1,7.29,7.281M20.35,15.6V18.35a1.834,1.834,0,0,1-2,1.834,18.148,18.148,0,0,1-7.914-2.815,17.882,17.882,0,0,1-5.5-5.5A18.148,18.148,0,0,1,2.119,3.916a1.834,1.834,0,0,1,1.825-2H6.7A1.834,1.834,0,0,1,8.529,3.494a11.774,11.774,0,0,0,.642,2.577,1.834,1.834,0,0,1-.413,1.935L7.594,9.171a14.672,14.672,0,0,0,5.5,5.5l1.165-1.165A1.834,1.834,0,0,1,16.2,13.1a11.774,11.774,0,0,0,2.577.642A1.834,1.834,0,0,1,20.35,15.6Z" transform="translate(-1.111 0.104)" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
        </Svg>
    )
}