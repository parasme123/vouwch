...
const styles = StyleSheet.create({
    ...
    checkBoxText2: { color:Colors.appcolor, fontFamily: Fonts.ProximaNovaRegular, fontSize: wp("3.5%") },
    ...
    button: { color:Colors.appcolor, fontSize: wp("4.5%"), fontFamily: Fonts.ProximaNovaSemibold },
