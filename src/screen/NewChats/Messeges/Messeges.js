...
const Messeges = (props) => {
    ...
    const [data, setData] = useState([
        ...
        { id: 2, msg: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", time: "10:21 PM", img: Imagepath.read },
        { id: 1, msg: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", time: "11:21 PM", img: Imagepath.threeDots },
        { id: 1, msg: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", time: "12:21 PM", },
        { id: 2, msg: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", time: "10:21 PM", },
            ...
            <View style={styles.upperView}>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate('UserGroup', { selectedUser })}
                    ...
                    <View style={styles.info}>
                        <Text style={styles.alexTxt}>Kathryn Alexander</Text>
