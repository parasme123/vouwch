        ...
        <ImageBackground source={Imagepath.background} style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.container1}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("edit")} style={styles.pageButton}>
                    ...
                    <View style={[{ justifyContent: "space-between",alignContent:"center", }, styles.pageButton]}>
...
const styles = StyleSheet.create({
    ...
    container: { width: "90%", alignSelf: "center", alignItems: "center", position: "absolute", backgroundColor: "#ffffff", borderRadius: 10, marginTop: 65, borderWidth: 1, borderRadius: 20, borderColor: '#00000012', borderBottomWidth: 2, shadowColor: '#00000012', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.6, shadowRadius: 7, flex:1, paddingVertical:20 },
    ...
    ratingViewmain: {   flexDirection: "row", justifyContent: "space-around", alignItems: "center", borderRadius: 10, paddingHorizontal:7 },
    star: { height: 12, width: 12 },
    ratingText: { color: "#000000", fontSize: 15, fontFamily:Fonts.ProximaNovaMedium, },
    clinicianReview: { color: "#858585", fontSize: 15,fontFamily:Fonts.ProximaNovaRegular,  },
