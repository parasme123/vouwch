        ...
        <ImageBackground source={Imagepath.background} style={{ flex: 1 }}>
            <View style={{ height: 115, width: "100%", backgroundColor:Colors.appcolor, }}>
                ...
                <View style={{ flexDirection: "row", width: "85%", justifyContent: "space-between", alignItems: "center", alignSelf: "center", fontFamily: Fonts.ProximaNovaSemibold }}>
                    <TouchableOpacity onPress={() => { MessagePage() }} style={[{ backgroundColor: Massageprop ? "#19428A" : null }, styles.button]} >
                        <Text style={{ color: "#ffffff", fontSize: 13 }}>Massage</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => { CommentpropPage() }} style={[{ backgroundColor: Commentprop ? "#19428A" : null, fontFamily: Fonts.ProximaNovaSemibold }, styles.button]} >
