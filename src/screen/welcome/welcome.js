    ...
    return (
        <ImageBackground
            ...
            <View style={styles.categouryButton}>
                ...
                <TouchableOpacity style={[{ backgroundColor: SlectUser=='PERSONAL' ? Colors.appcolor : "#D7EFFB" }, styles.touchablePersonalButton]} onPress={() => { PersonalPage() }} >
                ...
                <TouchableOpacity style={[{ backgroundColor: SlectUser=='BUSINESS'? Colors.appcolor : "#D7EFFB" }, styles.doctorIconbtn]} onPress={() => { BusinessPage() }}>
                    ...
                    <Text style={[{color: SlectUser=='BUSINESS' ?  "#fff":Colors.appcolor },styles.doctorIconTextSub]}>( Doctor, Hospital and clinics)</Text>
                </TouchableOpacity>
            </View>
            {/* Login  Button */}
