                ...
                >
                    ...
                    <View style={styles.mainContPhoto}>
                        ...
                        <TouchableOpacity style={[{backgroundColor: Photos ? "#245FC7":"#FBECE3"},styles.PhotosView]} onPress={()=>PhotosButton()}>
                            <Image style={[{tintColor:Photos?"#fff":"#000"},styles.Imageicon]} resizeMode='contain' source={Imagepath.Photos} />
                            <Text style={[styles.PhotoText, { color:Photos? "#fff":'#000' }]}>{String.Photos}</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={[{backgroundColor: Videos ? "#245FC7":"#FBECE3"},styles.VideoView]} onPress={()=>videosButton()}>
                            ...
                            <Text style={[styles.PhotoText, {color:Videos? "#fff":"#000" }]}>{String.Videos}</Text>
                        </TouchableOpacity>
                        </View>
                    </View>
